...
public:
	...
	template <typename T>
	std::ostream& operator<<(T t) { return(getStream() << t); }
	Log();
...
export inline std::string format(const std::initializer_list<char> list);
